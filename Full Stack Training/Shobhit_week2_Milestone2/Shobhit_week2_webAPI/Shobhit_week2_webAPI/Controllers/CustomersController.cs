...
namespace Shobhit_week2_webAPI.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        //public CustomersController(ShobhitProductsDbApiContext context)
        //{
        //    _context = context;
        //}
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
          if (_context.Customers == null)
          {
              return Problem("Entity set 'ShobhitProductsDbApiContext.Customers'  is null.");
          }
        ...
        public async Task<ActionResult<IEnumerable<Customer>>> GetCustomersByWalletBalance(decimal balance)
        {
            return await _context.Customers
                                 .Where(c => c.CWalletBalance == 0)
                                 .ToListAsync();
        }
