...
using websiteAzure.Models;

namespace websiteAzure.Controllers
{
    public class StudentsController : Controller
    {
        private readonly CollegeContext _context=new CollegeContext();
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FirstName,LastName,DepartmentId")] Student student)
        {
